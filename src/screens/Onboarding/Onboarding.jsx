        ...
        <div className="OnboardingWrapper">
            ...
            <form onSubmit={handleSubmit} className="OnboardingInformationWrapper">
                    ...
                    <div className="OnboardingInputWrapper">
                        ...
                        <div className="OnboardingInputs">
                            <div className="OnboardingInput">
                                ...
                                <input onChange={handleAddress} type="text" name="address" id="address" placeholder="Enter Address" required />
                            </div>
                            <div className="OnboardingInput">
                                <label htmlFor="country">Country</label>
                                <input onChange={handleAddress} type="text" name="country" id="country" placeholder="Enter Country" required />
                            </div>
                        </div>
                        <div className="OnboardingInputs">
                            <div className="OnboardingInput">
                                <label htmlFor="state">State</label>
                                <input onChange={handleAddress} type="text" name="state" id="state" placeholder="Enter State" required />
                            </div>
                            <div className="OnboardingInput">
                                <label htmlFor="city">City</label>
                                <input onChange={handleAddress} type="text" name="city" id="city" placeholder="Enter City" required />
                            </div>
                        </div>
                        <div className="OnboardingInputs">
                            <div className="OnboardingInput">
                ...
                <div className="OnboardingGenarelInformation">
                    ...
                    {formState?.contactDetails.map((info, index) =>
                        <div key={index} className="OnboardingInputWrapper">
                            {index !== 0 && <div className="OnboardContactTitle">
                                <h6>Contact Details {index + 1}</h6>
                                <p onClick={() => decreaseContactDetails(index)}>Remove</p>
                            </div>}
                            <div className="OnboardingInputs">
                                <div className="OnboardingInput">
                                    <label htmlFor="name">Name</label>
                    ...
                    <div className="OnboardingInputWrapper">
                        <div className="OnboardingInputs">
                            <div className="OnboardingInput">
                                ...
                                <input onChange={handleBankDetails} type="text" name="account_holder_name" id="account_holder_name" placeholder="Enter Account Holder Name" required />
                            </div>
                            <div className="OnboardingInput">
                                <label htmlFor="account_no">Account No</label>
                                <input onChange={handleBankDetails} type="text" name="account_no" id="account_no" placeholder="Enter Account No" required />
                            </div>
                        </div>
                        <div className="OnboardingInputs">
                            <div className="OnboardingInput">
                                <label htmlFor="bank_name">Bank Name</label>
                                <input onChange={handleBankDetails} type="text" name="bank_name" id="bank_name" placeholder="Enter Bank Name" required />
                            </div>
                            <div className="OnboardingInput">
                                <label htmlFor="branch_name">Branch Name</label>
                                <input onChange={handleBankDetails} type="text" name="branch_name" id="branch_name" placeholder="Enter Branch Name" required />
                            </div>
                        </div>
                        <div className="OnboardingInputs">
                            <div className="OnboardingInput">
                                <label htmlFor="ifsc_code">IFSC Code</label>
                                <input onChange={handleBankDetails} type="number" name="ifsc_code" id="ifsc_code" placeholder="Enter IFSC Code" required />
                            </div>
                ...
                <div className="flexJustifyEnd">
                    <CustomButton classId="OnboardingBtn">{isLoading ? <CircularProgress sx={{ color: "white" }}
                        size={20} /> : "Save and Continue"}</CustomButton>
                </div>
            </form>
            {/* onBoarding Modal */}
            <CustomModal open={open} handleClose={sellerType === "" ? "" : handleClose}>
                <Box sx={style}>
                    ...
                    <div className="OnboardingModal">
                        ...
                        <div onClick={() => handleModalData("Boutique")} className="OnboardingModalItem">
