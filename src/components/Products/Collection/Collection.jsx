...
const Collection = ({ formState, dispatch }) => {
    ...
    const handleCreateCollection = async (e) => {
        ...
        setLsloading(true)
        try {
            const res = await API.post("/api/seller/collection", { name: newCollection });
            if (res.status === 200) {
    ...
    return (
        <section className="collectionWrapper">
            <div className="categoryContainer">
                <div onClick={() => setCollection("Choose")} className={`categoryOptions marginRight20 ${collection === "Choose" && "categoryActive"}`}>
                    <p>Choose collection</p>
                </div>
                <div onClick={() => setCollection("Create")} className={`categoryOptions marginRight20 ${collection === "Create" && "categoryActive"}`}>
                ...
                <div className="chooseCategory">
                    <div className="chooseCategoryBox">
                        ...
                        <div className="chooseCategoryInput">
                            <select required onChange={handleCollection} value={formState?.collection}>
